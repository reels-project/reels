...
@FacesRenderer(componentFamily = ComponentDefines.GANTT, rendererType = ComponentDefines.GANTT_RENDER)
public class GanttRenderer extends DirectiveRenderer {
	@Override
	...
	protected void encodeMarkup(FacesContext context, UIComponent component) throws IOException {
		...
		writer.writeAttribute("class", "jsf-gantt-chart", null);
