...
@FacesRenderer(componentFamily = ComponentDefines.DATATABLE_TR, rendererType = ComponentDefines.DATATABLE_TR_RENDERER)
public class TrRenderer extends DirectiveRenderer {
	@Override
...
//		super.encodeScript(context, component);
	...
	protected void encodeMarkup(FacesContext context, UIComponent component) throws IOException {
		...
		writer.startElement("jsf-tr", null);
