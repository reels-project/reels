...
@FacesRenderer(componentFamily = ComponentDefines.DATATABLE_THEAD, rendererType = ComponentDefines.DATATABLE_THEAD_RENDERER)
public class TheadRenderer extends DirectiveRenderer {
	@Override
...
//		super.encodeScript(context, component);
	...
	protected void encodeMarkup(FacesContext context, UIComponent component) throws IOException {
		...
		writer.startElement("jsf-thead", null);
