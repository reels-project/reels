...
@FacesRenderer(componentFamily = ComponentDefines.DATATABLE_TH, rendererType = ComponentDefines.DATATABLE_TH_RENDERER)
public class ThRenderer extends DirectiveRenderer {
	@Override
