...
public class FloatConverterTest {
	...
	public void nonOptional_getAsObject(){
		...
		assertThat(o, instanceOf(Float.class));
		Float b = (Float)o;
	...
	public void nonOptional_getAsString(){
		Converter converter = getConverter(false);
		String s = converter.getAsString(context, component, Float.valueOf(12345));
	...
	public void optional_getAsObject(){
		...
		Optional<Float> op = (Optional<Float>)o;
	...
	public void optional_getAsString(){
		Converter converter = getConverter(true);
		String s = converter.getAsString(context, component, Optional.of(Float.valueOf(12345)));
