...
public class BigIntegerConverterTest {
	...
	public void nonOptional_getAsObject(){
		...
		assertThat(o, instanceOf(BigInteger.class));
	...
	public void nonOptional_getAsString(){
		Converter converter = getConverter(false);
		String s = converter.getAsString(context, component, BigInteger.valueOf(12345));
	...
	public void optional_getAsObject(){
		...
		Optional<BigInteger> op = (Optional<BigInteger>)o;
	...
	public void optional_getAsString(){
		Converter converter = getConverter(true);
		String s = converter.getAsString(context, component, Optional.of(BigInteger.valueOf(12345)));
